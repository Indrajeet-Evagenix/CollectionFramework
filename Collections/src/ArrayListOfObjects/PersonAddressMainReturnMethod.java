...
public class PersonAddressMainReturnMethod {

	ArrayList<Person> elements(ArrayList<Person> all) {
	...
	ArrayList<Person> displayCityWise(ArrayList<Person> per) {
		for (Person p : per) {
	...
	ArrayList<Person> removePerson(ArrayList<Person> per) {
	...
	public static void main(String[] args) {
		...
		PersonAddressMainReturnMethod pam = new PersonAddressMainReturnMethod();

		al = pam.elements(al);
		System.out.println(al);

		al = pam.displayCityWise(al);

		al = pam.removePerson(al);
		System.out.println(al);
